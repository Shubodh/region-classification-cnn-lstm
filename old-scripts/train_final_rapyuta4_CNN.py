...
#    checkpoint = torch.load("/home/shubodh/places365_training/places365/trained_models_rapyuta4_phase2/resnet18_best_phase2_unfrozen_may25.pth.tar")
    ...
    params_Nmin1 = []
    for child in list(model_resnet18.module.cuda().children())[:-1]:
        params_Nmin1.extend(list(child.parameters()))

    #print list(model_resnet18.module.fc.parameters())
    #print ("size of list fc:{lis}".format(lis=len(list(model_resnet18.module.fc.parameters()))))
    #print len(params_Nmin1)
#    print ("size of list allmin1:{lis1}".format(lis1=len(list()))
